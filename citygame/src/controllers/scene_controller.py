...
from citygame.src.frameprocessors.world_creation_scene import WorldCreationScene
...
class SceneController:
    ...
    def _get_scene_object(self, scene_id: SceneEnum) -> Scene:
        ...
        if scene_id == SceneEnum.WorldCreation:
            return WorldCreationScene(self.game_state, self)
